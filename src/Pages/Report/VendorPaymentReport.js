...
const VendorPaymentReport = () => {
  ...
  const breadCrumbTitle = "Vendor Payment Report";
  const breadcrumbItem = "Vendor Payment Report";
  const API_URL = `${API_WEB_URLS.MASTER}/0/token/VendorNameMaster`;
  const API_URL1 = `${API_WEB_URLS.MASTER}/0/token/VendorPaymentReport`;
