...
const PaymentReport = () => {
  ...
  const breadCrumbTitle = "Payment Report";
  const breadcrumbItem = "Payment Report";
  const API_URL = `${API_WEB_URLS.MASTER}/0/token/PaymentEMDTenderMaster`;
  ...
  const columns = useMemo(
    () => [
      ...
      { Header: "", accessor: "EMD:" , Cell: () => <span style={{ color: "blue" }}>EMD:</span>,},
      ...
      { Header: "EMD TENDER AMOUNT", accessor: "EMD TENDER AMOUNT" },
      { Header: "", accessor: "TENDER:", Cell: () => <span style={{ color: "blue" }}> TENDER: </span>  },
      { Header: "TENDER AMOUNT", accessor: "TENDER AMOUNT" }, 
    ],
    []
  );
